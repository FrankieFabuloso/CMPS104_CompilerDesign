...
%token TOK_VARDECL TOK_FUNCTION TOK_PARAM TOK_PROTOTYPE
...
function    : identdecl funchead ')' block {
               free_ast($3);
               $$ = adopt3(new_astree(TOK_FUNCTION, $1->filenum,
                     $1->linenum, $1->offset, ""), $1, $2, $4);
            }
            | identdecl funchead ')' ';' {
               free_ast2($4, $3);
               $$ = adopt2(new_astree(TOK_PROTOTYPE, $1->filenum,
                     $1->linenum, $1->offset, ""), $1, $2);   
            }
            | identdecl '(' ')' block { 
               free_ast($3);
               $$ = adopt3(new_astree(TOK_FUNCTION, $1->filenum,
